const productos = [
  ...
  { id: 2, categoria: "samsung", nombre: "Samsung Galaxy S24+", imagen: "img/s24ultra.png", badge: "Potencia diaria", descripcion: "Snapdragon 8 Gen 3, pantalla de 6.7″ a 120Hz, cámara de 50MP, batería de 4900mAh.", precio: "$999.99", moneda: "USD" },
  ...
  { id: 2, categoria: "iphone", nombre: "iPhone 16 Pro", imagen: "img/iphone16pm.png", badge: "Profesional compacto", descripcion: "Pantalla de 6.3″, chip A18 Pro, cámara de 48MP, zoom 5x y titanio.", precio: "$1099.99", moneda: "USD" }
];
